...
@section('judul')
<h1 class="h3 mb-0 text-gray-800">Data Pengguna PR/PK</h1>
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="/beranda">Beranda</a></li>
    <li class="breadcrumb-item active" aria-current="page">Data Pengguna PR/PK</li>
  </ol>
</h1>
@endsection
        ...
        <table id="dataTableHover" class="table table-bordered align-items-center table-hover" >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: center">{{ $data->prpk }}</td>
              <td>{{ $data->email }}</td>

              <td style="text-align: center">
                <a href="edit_userprpk/{{ $data->id }}">
